...
![](../_media/admin-panel-tabs.png ':size=600x40')
...
![](../_media/admin-panel-users.png ':size=600x180')
...
![](../_media/admin-panel-settings.png ':size=600x500')
...
![](../_media/admin-panel-functions.png ':size=600x600')
...
![](../_media/admin-panel-prro.png ':size=600x300')
...
- На сторінці [Каса](/menu/pos) зʼявляються кнопки **X Звіт** і **Звіт за день**.
...
> Налаштування поведінки PWA-клієнта.

![](../_media/admin-panel-mobile.png ':size=600x300')

- Перелік студій (для мульти-студійних аккаунтів).
- Налаштування push-сповіщень за замовчуванням.
- QR-код для встановлення додатку.
