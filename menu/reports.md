...
- **Тип звіту** — випадаючий список:
  ...
  - **Розширений** — детальний фінансовий звіт (агрегати по методах оплати / типах продажу / категоріях). Реалізовано в межах **FC-268**.
  - **Потребує уточнення** — клієнти у яких відсутній телефон / не заповнені дані (**FC-110**).
...
- **Абонемент** — опційний випадаючий список (привʼязка категорії до конкретного абонементу).
