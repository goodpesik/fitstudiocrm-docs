...
- **Тип звіту** — випадаючий список:
  ...
  - **Потребують уточнення** — список клієнтів, у яких **не заповнено поле телефону** в [картці клієнта](/menu/clients#_3-2-6-редагування-клієнта). Інші поля (email, дата народження) тут не враховуються. Зручно для контролю якості бази, бо без телефону клієнт не отримуватиме пуш-сповіщення з мобільного додатку.
...
- **Статус** — Зміну відкрито / Зміну закрито.
...
- **Динамічні колонки** — система групує всі тренування періоду за **категоріями**, і кожна категорія стає окремою колонкою. Значення і тип розрахунку беруться **з категорії тренування** ([Категорії](/login/settings#категорії)):
  ...
  - **За тренування** (`PerWorkout`) — `кількість оплачуваних тренувань × baseRate`. Оплачуваним вважається заняття, на яке прийшов хоча б один клієнт або за яке було списання через пізню відміну.
...
- **Зарплата** — `години × погодинна ставка з профілю адміна`, без бонусу.
- **Сума** — `Зарплата + Бонус`.
...
> Оцінки, які клієнти залишають через застосунок.

- Загальний середній рейтинг студії та кількість оцінок.
- Рейтинг кожного тренера окремо.
- Перелік відгуків із текстом та датою. Ролі **Супер Адмін** і **Адмін** можуть видалити відгук.

> ℹ️ Зірки стають публічними лише тоді, коли оцінок достатньо, щоб середнє щось означало. До того клієнти рейтингу не бачать.
