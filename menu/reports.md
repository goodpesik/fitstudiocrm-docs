...
- **Тип звіту** — випадаючий список:
  ...
  - **Потребують уточнення** — список клієнтів, у яких **не заповнено поле телефону** в [картці клієнта](/menu/clients#_326-Редагування-клієнта). Інші поля (email, дата народження) тут не враховуються. Зручно для контролю якості бази, бо без телефону клієнт не отримуватиме пуш-сповіщення з мобільного додатку.
